...
changeAvatarBtn.addEventListener('click', function () {
	uploadPhoto.click();
	setPosition(changeAvatarBtn, uploadPhoto);
});
...
let boardPicked = document.getElementById("board-picked");
let informationSection = document.getElementById("information-section");
let imformationPicked = document.getElementById("information-picked");

boardPicked.addEventListener('click', function() {
	boardSection.className = "board-section";
	informationSection.className = "information-section hide";
});

imformationPicked.addEventListener("click", function() {
	boardSection.className = "board-section hide";
