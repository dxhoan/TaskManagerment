    ...
    <div class="container sign-up-mode">
            ...
            <div class="signin-signup">
                <form method="POST" action="{{ route('register') }}" class="sign-up-form">
                    ...
                    <div class="input-field form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <input id="name" type="text" placeholder="Username" name="name" value="{{ old('name') }}" required autofocus style="border-radius: 55px;" />
                        @if ($errors->has('name'))
                    ...
                    <div class="input-field form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                        ...
                        <input id="email" type="email" placeholder="Email" name="email" value="{{ old('email') }}" required style="border-radius: 55px;" />
                        @if ($errors->has('email'))
                        <span class="help-block">
                    ...
                    <div class="input-field form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                        ...
                        <input id="password" type="password" placeholder="Password" name="password" required style="border-radius: 55px;" />
                    ...
                    <div class="social-media">
                        ...
                        <a href="https://twitter.com/?lang=vi" class="social-icon">
        ...
        <div class="panels-container">
            ...
            <div class="panel right-panel">
                ...
                <img src="/auth/img/Picture2.png" class="image" alt="" />
            </div>
        </div>
    </div>
